...
\section{Methods}
\label{sec:org3cf0f51}


\subsection{Field Methods/Study Design}
\label{sec:org670fb7f}

\subsubsection{Study Design}
\label{sec:org827452a}
...
\caption{\label{fig:org9fa6f68}Graphical representation of ACTIVE dataset Study Design.}
\end{figure} 
...
\caption{\label{fig:orgd45528c}Sketch of a mosaic plot for the different cognitive intervention arms.}
\end{figure}
...
\item Test for interaction between intervention arm and booster
\item Create diagnostic plots and assess assumptions
\end{itemize}

\subsection{Quantitative Backdrop}
\label{sec:org50a9cdb}

Figure \ref{fig:orgd7ebbfb} shows the adjusted hazard risk confidence intervals for the speed cognitive training intervention arm with booster intervention sessions (interval A), and the speed cognitive intervention arm without booster intervention sessions (interval B).
...
\label{sec:orgc5ba91c}

\subsection{Communication}
\label{sec:org2b60091}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{visualization.jpg}
\caption{\label{fig:org0aa2943}Illustration of what a tableplot for the impact of cognitive training invervention arms on likelihood of ADRD diagnosis.}
\end{figure}
